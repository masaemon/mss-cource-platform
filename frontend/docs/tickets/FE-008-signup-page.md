...
- `frontend/src/views/auth/SignupView.vue` (完全実装)
- `frontend/src/utils/auth.js` (validatePassword 関数使用)
...
```bash
npm run dev
# http://localhost:5173/auth/signup にアクセス
```
...
- **弱い**: 8文字未満、または単純
- **普通**: 8文字以上、大小文字と数字を含む
- **強い**: 12文字以上、大小文字、数字、特殊文字を含む
- **非常に強い**: すべての条件を満たす長いパスワード
