...
- `frontend/src/views/ProfileView.vue` (新規作成)
- `frontend/src/api/auth.js` (updateProfile, changePassword 使用)

## 検証方法

```bash
npm run dev
# ログイン後、http://localhost:5173/profile にアクセス
```
